...
<body>
   ...
   <!-- 현재 locale : ko_kr 표기는 언어_국가 형식 : 화폐단위 won  -->
   <fmt:formatNumber  value="9999999"  type="currency"/><br> 
   <!--  locale 변경 : en_us -->
   <fmt:setLocale value="en_us"/>		<!-- 화폐단위 dollar -->  
   <fmt:formatNumber  value="9999999"  type="currency"/><br> 
   ...
   패턴이 없으면 날짜 타입으로 변환을 못합니다.(문자열을 타입으로 캐스팅)-->
   <fmt:parseDate value="2022-11-03 20:14:45" var="datetime1" 
               pattern="yyyy-MM-dd HH:mm:ss"/> 
   지정된 시간과 날짜 : <c:out value="${datetime1 }"/>
   <br>	<!-- 출력결과 : Thu Nov 03 20:14:00 KST 2022  -->		<!-- 아래 출력 결과는 locale en_us -->
